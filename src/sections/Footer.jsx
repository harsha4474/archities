...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-deep-blue to-premium-red text-white">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            <div className="flex gap-4">
              <motion.a
                href="https://www.instagram.com/archities_interiors/"
                target="_blank"
              ...
              <motion.a
                href="https://youtube.com/@architiesinfo8611?si=2WcTFnQhGU6iKHbx"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.2, rotate: 360 }}
                transition={{ duration: 0.3 }}
          ...
          >
            ...
            <ul className="space-y-3 text-gray-200">
              <li className="flex items-center gap-2">
                ...
                <span>info@archities.com</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+919030938830" className="hover:underline">+91 90309 38830</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
